        ...
        <tr>
          ...
          <td>
            @if(!empty($has_done[$student->id]['作業']) and $has_done[$student->id]['作業'] != "未指派！")
              <a href="#" class="btn btn-primary" onclick="window.open('{{ url('admin/task/view_one/'.$has_done[$student->id]['序號']) }}', '作品', config='height=600,width=800');"><i class="fa fa-check-square"></i> 已上傳</a>
            @endif
